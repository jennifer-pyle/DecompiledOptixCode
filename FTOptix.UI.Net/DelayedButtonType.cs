...
// Type: FTOptix.UI.DelayedButtonType
...
namespace FTOptix.UI
{
  ...
  public class DelayedButtonType : ButtonType
  {
    public double Delay
    {
    ...
    public InstanceNodeCollection<DelayedButton> Instances
    {
      get => new InstanceNodeCollection<DelayedButton>((IUANode) this);
    }
  }
}
