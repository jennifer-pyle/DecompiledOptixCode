...
// Type: FTOptix.UI.ColumnLayoutType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:UI", Number = 8)]
  public class ColumnLayoutType : ContainerType
  {
    public ContentVerticalAlignment ContentAlignment
    {
      get
      {
    ...
    public InstanceNodeCollection<ColumnLayout> Instances
    {
      get => new InstanceNodeCollection<ColumnLayout>((IUANode) this);
    }
