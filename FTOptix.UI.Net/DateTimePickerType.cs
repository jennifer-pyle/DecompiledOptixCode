...
// Type: FTOptix.UI.DateTimePickerType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:UI", Number = 631)]
  public class DateTimePickerType : ItemType
  {
    public DateTime Value
    {
      get => (DateTime) this.Refs.GetVariable(nameof (Value)).Value.Value;
    ...
    public DateTimePickerInputFormat InputFormat
    {
      get => (DateTimePickerInputFormat) (int) this.GetOptionalVariableValue(nameof (InputFormat));
      set => this.SetOptionalVariableValue(nameof (InputFormat), new UAValue((int) value));
    }
    ...
    public IUAVariable InputFormatVariable => this.GetOrCreateVariable("InputFormat");

    public InstanceNodeCollection<DateTimePicker> Instances
    {
      get => new InstanceNodeCollection<DateTimePicker>((IUANode) this);
    }
  }
}
