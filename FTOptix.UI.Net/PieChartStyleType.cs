...
// Type: FTOptix.UI.PieChartStyleType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:UI", Number = 1059)]
  public class PieChartStyleType : ControlStyleType
  {
    public double HoleSizePercent
    {
      get => (double) this.GetOptionalVariableValue(nameof (HoleSizePercent));
      set => this.SetOptionalVariableValue(nameof (HoleSizePercent), new UAValue(value));
    }

    public IUAVariable HoleSizePercentVariable => this.GetOrCreateVariable("HoleSizePercent");
    ...
    public InstanceNodeCollection<PieChartStyle> Instances
    {
      get => new InstanceNodeCollection<PieChartStyle>((IUANode) this);
    }
  }
}
