...
namespace FTOptix.UI
{
  ...
  public class XYChartType : ItemType
  {
    ...
    public InstanceNodeCollection<XYChart> Instances
    {
      get => new InstanceNodeCollection<XYChart>((IUANode) this);
    }
  }
}
