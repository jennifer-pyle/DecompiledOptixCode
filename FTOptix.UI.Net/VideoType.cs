...
namespace FTOptix.UI
{
  ...
  public class VideoType : ItemType
  {
    ...
    public InstanceNodeCollection<Video> Instances
    {
      get => new InstanceNodeCollection<Video>((IUANode) this);
    }
  }
}
