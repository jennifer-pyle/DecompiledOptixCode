...
// Type: FTOptix.UI.NumberAnimationType
...
namespace FTOptix.UI
{
  ...
  public class NumberAnimationType : AbstractAnimationType
  {
    public float From
    {
    ...
    public InstanceNodeCollection<NumberAnimation> Instances
    {
      get => new InstanceNodeCollection<NumberAnimation>((IUANode) this);
    }
  }
}
