...
// Type: FTOptix.UI.AdvancedSVGImageElementPropertyType
...
namespace FTOptix.UI
{
  ...
  public class AdvancedSVGImageElementPropertyType : UAObjectType
  {
    public string ID
    {
    ...
    public InstanceNodeCollection<AdvancedSVGImageElementProperty> Instances
    {
      get => new InstanceNodeCollection<AdvancedSVGImageElementProperty>((IUANode) this);
    }
  }
}
