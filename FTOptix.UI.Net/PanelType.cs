...
namespace FTOptix.UI
{
  ...
  public class PanelType : ContainerType
  {
    ...
    public InstanceNodeCollection<Panel> Instances
    {
      get => new InstanceNodeCollection<Panel>((IUANode) this);
    }
