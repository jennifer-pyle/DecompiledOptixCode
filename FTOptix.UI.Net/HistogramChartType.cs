...
// Type: FTOptix.UI.HistogramChartType
...
namespace FTOptix.UI
{
  ...
  public class HistogramChartType : ItemType
  {
    public NodeId Model
    {
    ...
    public InstanceNodeCollection<HistogramChart> Instances
    {
      get => new InstanceNodeCollection<HistogramChart>((IUANode) this);
    }
  }
}
