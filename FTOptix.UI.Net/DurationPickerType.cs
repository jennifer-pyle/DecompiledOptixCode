...
// Type: FTOptix.UI.DurationPickerType
...
namespace FTOptix.UI
{
  ...
  public class DurationPickerType : ItemType
  {
    public double Value
    {
    ...
    public InstanceNodeCollection<DurationPicker> Instances
    {
      get => new InstanceNodeCollection<DurationPicker>((IUANode) this);
    }
  }
}
