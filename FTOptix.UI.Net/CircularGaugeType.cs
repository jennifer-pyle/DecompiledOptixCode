...
// Type: FTOptix.UI.CircularGaugeType
...
namespace FTOptix.UI
{
  ...
  public class CircularGaugeType : ItemType
  {
    public float Value
    {
    ...
    public InstanceNodeCollection<CircularGauge> Instances
    {
      get => new InstanceNodeCollection<CircularGauge>((IUANode) this);
    }
  }
}
