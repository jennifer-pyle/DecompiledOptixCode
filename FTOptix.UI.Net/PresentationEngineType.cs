...
// Type: FTOptix.UI.PresentationEngineType
...
namespace FTOptix.UI
{
  ...
  public class PresentationEngineType : UAObjectType
  {
    ...
    public InstanceNodeCollection<PresentationEngine> Instances
    {
      get => new InstanceNodeCollection<PresentationEngine>((IUANode) this);
    }
  }
}
