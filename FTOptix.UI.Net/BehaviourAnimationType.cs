...
// Type: FTOptix.UI.BehaviourAnimationType
...
namespace FTOptix.UI
{
  ...
  public class BehaviourAnimationType : UAObjectType
  {
    public int Duration
    {
    ...
    public InstanceNodeCollection<BehaviourAnimation> Instances
    {
      get => new InstanceNodeCollection<BehaviourAnimation>((IUANode) this);
    }
  }
}
