...
namespace FTOptix.UI
{
  ...
  public class WindowType : BaseUIObjectType
  {
    public float X
    {
    ...
    public InstanceNodeCollection<Window> Instances
    {
      get => new InstanceNodeCollection<Window>((IUANode) this);
    }
  }
}
