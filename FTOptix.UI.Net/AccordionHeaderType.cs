...
// Type: FTOptix.UI.AccordionHeaderType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:UI", Number = 1011)]
  public class AccordionHeaderType : ContainerType
  {
    ...
    public InstanceNodeCollection<AccordionHeader> Instances
    {
      get => new InstanceNodeCollection<AccordionHeader>((IUANode) this);
    }
  }
}
