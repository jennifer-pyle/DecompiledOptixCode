...
// Type: FTOptix.UI.PanelLoaderType
...
namespace FTOptix.UI
{
  ...
  public class PanelLoaderType : ContainerType
  {
    public NodeId Panel
    {
    ...
    public InstanceNodeCollection<PanelLoader> Instances
    {
      get => new InstanceNodeCollection<PanelLoader>((IUANode) this);
    }
