...
namespace FTOptix.UI
{
  ...
  public class ImageType : ContainerType
  {
    ...
    public InstanceNodeCollection<Image> Instances
    {
      get => new InstanceNodeCollection<Image>((IUANode) this);
    }
