...
namespace FTOptix.UI
{
  ...
  public class UISession : Session
  {
    ...
    public event EventHandler<IdleTimeoutEvent> OnIdleTimeout
    {
      add
      {
        this.GetOrCreateCustomEventHandler(new NodeId(NamespaceMapProvider.GetNamespaceIndex("urn:FTOptix:UI"), 694U), typeof (EventHandler<IdleTimeoutEvent>), typeof (IdleTimeoutEvent)).Add((Delegate) value);
      }
      remove
      {
        this.GetOrCreateCustomEventHandler(new NodeId(NamespaceMapProvider.GetNamespaceIndex("urn:FTOptix:UI"), 694U), typeof (EventHandler<IdleTimeoutEvent>), typeof (IdleTimeoutEvent)).Remove((Delegate) value);
      }
    }
