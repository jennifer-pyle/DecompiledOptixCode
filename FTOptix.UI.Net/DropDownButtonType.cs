...
// Type: FTOptix.UI.DropDownButtonType
...
namespace FTOptix.UI
{
  ...
  public class DropDownButtonType : ButtonType
  {
    public NodeId Panel
    {
    ...
    public InstanceNodeCollection<DropDownButton> Instances
    {
      get => new InstanceNodeCollection<DropDownButton>((IUANode) this);
    }
  }
}
