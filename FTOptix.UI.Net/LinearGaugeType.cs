...
// Type: FTOptix.UI.LinearGaugeType
...
namespace FTOptix.UI
{
  ...
  public class LinearGaugeType : ItemType
  {
    public float Value
    {
    ...
    public InstanceNodeCollection<LinearGauge> Instances
    {
      get => new InstanceNodeCollection<LinearGauge>((IUANode) this);
    }
  }
}
