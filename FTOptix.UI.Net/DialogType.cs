...
namespace FTOptix.UI
{
  ...
  public class DialogType : ContainerType
  {
    public bool Modal
    {
    ...
    public InstanceNodeCollection<Dialog> Instances
    {
      get => new InstanceNodeCollection<Dialog>((IUANode) this);
    }
