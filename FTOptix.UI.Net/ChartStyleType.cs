...
// Type: FTOptix.UI.ChartStyleType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:UI", Number = 869)]
  public class ChartStyleType : ControlStyleType
  {
    ...
    {
      get => new Color(this.GetOptionalVariableValue(nameof (GridColor)));
      set => this.SetOptionalVariableValue(nameof (GridColor), new UAValue(value.ARGB));
    }

    public IUAVariable GridColorVariable => this.GetOrCreateVariable("GridColor");
    ...
    public InstanceNodeCollection<ChartStyle> Instances
    {
      get => new InstanceNodeCollection<ChartStyle>((IUANode) this);
    }
  }
}
