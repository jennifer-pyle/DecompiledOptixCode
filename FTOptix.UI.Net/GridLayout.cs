...
namespace FTOptix.UI
{
  ...
  public class GridLayout : Container
  {
    ...
    public HorizontalAlignment ItemsHorizontalAlignment
    {
      get
      {
        return (HorizontalAlignment) (int) this.GetOptionalVariableValue(nameof (ItemsHorizontalAlignment));
      }
      set
      {
        this.SetOptionalVariableValue(nameof (ItemsHorizontalAlignment), new UAValue((int) value));
      }
    }
