...
namespace FTOptix.UI
{
  ...
  public class ListBoxType : ItemType
  {
    public NodeId Model
    {
    ...
    public InstanceNodeCollection<ListBox> Instances
    {
      get => new InstanceNodeCollection<ListBox>((IUANode) this);
    }
  }
}
