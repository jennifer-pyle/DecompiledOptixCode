...
namespace FTOptix.UI
{
  ...
  public class SpinBoxType : ItemType
  {
    public double Value
    {
    ...
    public InstanceNodeCollection<SpinBox> Instances
    {
      get => new InstanceNodeCollection<SpinBox>((IUANode) this);
    }
  }
}
