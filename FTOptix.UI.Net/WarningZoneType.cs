...
// Type: FTOptix.UI.WarningZoneType
...
namespace FTOptix.UI
{
  ...
  public class WarningZoneType : UAObjectType
  {
    public float From
    {
    ...
    public InstanceNodeCollection<WarningZone> Instances
    {
      get => new InstanceNodeCollection<WarningZone>((IUANode) this);
    }
  }
}
