...
namespace FTOptix.UI
{
  ...
  public class PdfViewerType : ItemType
  {
    ...
    public InstanceNodeCollection<PdfViewer> Instances
    {
      get => new InstanceNodeCollection<PdfViewer>((IUANode) this);
    }
