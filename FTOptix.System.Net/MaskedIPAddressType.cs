...
// Type: FTOptix.System.MaskedIPAddressType
...
namespace FTOptix.System
{
  ...
  public class MaskedIPAddressType : UAVariableType
  {
    public string Mask
    {
    ...
    public InstanceNodeCollection<MaskedIPAddress> Instances
    {
      get => new InstanceNodeCollection<MaskedIPAddress>((IUANode) this);
    }
  }
}
