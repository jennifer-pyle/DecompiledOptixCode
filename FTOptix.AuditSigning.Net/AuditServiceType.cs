...
// Type: FTOptix.AuditSigning.SigningControllerType
...
namespace FTOptix.AuditSigning
{
  ...
  public class SigningControllerType : UAObjectType
  {
    ...
    public InstanceNodeCollection<SigningController> Instances
    {
      get => new InstanceNodeCollection<SigningController>((IUANode) this);
    }
  }
}
