...
// Type: FTOptix.AuditSigning.SignResult
...
namespace FTOptix.AuditSigning
{
  public enum SignResult
  {
    Succeeded,
    Canceled,
    FirstUserLoginFailed,
    SecondUserLoginFailed,
    FirstUserNotAuthorized,
    SecondUserNotAuthorized,
    SecondUserMustBeDifferentFromFirstUser,
  }
}
