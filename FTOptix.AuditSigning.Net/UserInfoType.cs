...
// Type: FTOptix.AuditSigning.UserInfoType
...
namespace FTOptix.AuditSigning
{
  ...
  public class UserInfoType : UAObjectType
  {
    public NodeId User
    {
    ...
    public InstanceNodeCollection<UserInfo> Instances
    {
      get => new InstanceNodeCollection<UserInfo>((IUANode) this);
    }
  }
}
