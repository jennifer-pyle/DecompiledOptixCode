...
{
  [MapType(NamespaceUri = "urn:FTOptix:Core", Number = 2)]
  public class RightType : UAVariableType
  {
    public InstanceNodeCollection<Right> Instances
    {
      get => new InstanceNodeCollection<Right>((IUANode) this);
    }
  }
}
