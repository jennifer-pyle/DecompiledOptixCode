...
// Type: FTOptix.Core.AuditConditionConfirmEvent
...
{
  [CustomEventType(NamespaceUri = "http://opcfoundation.org/UA/", Number = 8961)]
  public class AuditConditionConfirmEvent : AuditConditionEvent
  {
