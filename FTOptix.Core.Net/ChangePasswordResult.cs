...
// Type: FTOptix.Core.ChangePasswordResult
...
namespace FTOptix.Core
{
  ...
  {
    public ChangePasswordResult(ChangePasswordResultCode resultCode)
    {
      this.ResultCode = resultCode;
    }

    public static implicit operator bool(ChangePasswordResult value) => value.Success;

    public bool Success => this.ResultCode == ChangePasswordResultCode.Success;

    public ChangePasswordResultCode ResultCode { get; }
  }
}
