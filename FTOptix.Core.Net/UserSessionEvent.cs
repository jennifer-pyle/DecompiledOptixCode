...
// Type: FTOptix.Core.UserSessionEvent
...
{
  [CustomEventType(NamespaceUri = "urn:FTOptix:Core", Number = 215)]
  public class UserSessionEvent : AuditEvent
  {
    public string Username { get; set; }

    public NodeId UserId { get; set; }
