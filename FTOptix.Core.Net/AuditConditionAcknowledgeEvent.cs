...
// Type: FTOptix.Core.AuditConditionAcknowledgeEvent
...
{
  [CustomEventType(NamespaceUri = "http://opcfoundation.org/UA/", Number = 8944)]
  public class AuditConditionAcknowledgeEvent : AuditConditionEvent
  {
    public ByteString ConditionEventId { get; set; }
