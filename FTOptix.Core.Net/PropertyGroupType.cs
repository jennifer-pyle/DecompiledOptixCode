...
// Type: FTOptix.Core.PropertyGroupType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:Core", Number = 276)]
  public class PropertyGroupType : UAObjectType
  {
    public InstanceNodeCollection<PropertyGroup> Instances
    {
      get => new InstanceNodeCollection<PropertyGroup>((IUANode) this);
    }
  }
}
