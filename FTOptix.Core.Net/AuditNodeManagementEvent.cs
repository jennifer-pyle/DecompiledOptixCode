...
// Type: FTOptix.Core.AuditNodeManagementEvent
...
{
  [CustomEventType(NamespaceUri = "http://opcfoundation.org/UA/", Number = 2090)]
  public class AuditNodeManagementEvent : AuditEvent
  {
  }
}
