...
// Type: FTOptix.Core.LogEventType
...
namespace FTOptix.Core
{
  ...
  public class LogEventType : UAObjectType
  {
    ...
    public InstanceNodeCollection<LogEvent> Instances
    {
      get => new InstanceNodeCollection<LogEvent>((IUANode) this);
    }
  }
}
