...
namespace FTOptix.Core
{
  ...
  {
    public const string Name = "FTOptix.Core";
    public const string Uri = "urn:FTOptix:Core";
    public const string OpcUaUri = "http://opcfoundation.org/UA/";
  }
}
