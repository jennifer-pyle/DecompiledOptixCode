...
// Type: FTOptix.Core.PasswordHash
...
{
  [MapDataType(NamespaceUri = "urn:FTOptix:Core", Number = 252)]
  public class PasswordHash : TypedStruct
  {
    [StructFieldInfo(0, new byte[] {}, ValueRank.OneDimension, new uint[] {0})]
    public byte[] Hash { get; set; }

    [StructFieldInfo(1, new byte[] {}, ValueRank.OneDimension, new uint[] {0})]
