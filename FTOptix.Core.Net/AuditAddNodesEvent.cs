...
// Type: FTOptix.Core.AuditAddNodesEvent
...
{
  [CustomEventType(NamespaceUri = "http://opcfoundation.org/UA/", Number = 2091)]
  public class AuditAddNodesEvent : AuditNodeManagementEvent
  {
