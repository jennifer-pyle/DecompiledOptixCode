...
// Type: FTOptix.Core.AuditConditionCommentEvent
...
{
  [CustomEventType(NamespaceUri = "http://opcfoundation.org/UA/", Number = 2829)]
  public class AuditConditionCommentEvent : AuditConditionEvent
  {
