...
// Type: FTOptix.Core.UserBasedRightType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:Core", Number = 3)]
  public class UserBasedRightType : UAVariableType
  {
    public InstanceNodeCollection<UserBasedRight> Instances
    {
      get => new InstanceNodeCollection<UserBasedRight>((IUANode) this);
    }
  }
}
