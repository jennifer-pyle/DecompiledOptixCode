...
// Type: FTOptix.Core.AuditWriteUpdateEvent
...
{
  [CustomEventType(NamespaceUri = "http://opcfoundation.org/UA/", Number = 2100)]
  public class AuditWriteUpdateEvent : AuditUpdateEvent
  {
