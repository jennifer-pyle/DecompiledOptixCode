...
// Type: FTOptix.Core.UserPasswordType
...
namespace FTOptix.Core
{
  ...
  public class UserPasswordType : UAVariableType
  {
    ...
    public InstanceNodeCollection<UserPassword> Instances
    {
      get => new InstanceNodeCollection<UserPassword>((IUANode) this);
    }
  }
}
