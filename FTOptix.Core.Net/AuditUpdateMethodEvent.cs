...
// Type: FTOptix.Core.AuditUpdateMethodEvent
...
{
  [CustomEventType(NamespaceUri = "http://opcfoundation.org/UA/", Number = 2127)]
  public class AuditUpdateMethodEvent : AuditEvent
  {
