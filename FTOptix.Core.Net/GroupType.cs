...
{
  [MapType(NamespaceUri = "urn:FTOptix:Core", Number = 17)]
  public class GroupType : UAObjectType
  {
    public InstanceNodeCollection<Group> Instances
    {
      get => new InstanceNodeCollection<Group>((IUANode) this);
    }
  }
}
