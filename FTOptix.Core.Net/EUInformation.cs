...
// Type: FTOptix.Core.EUInformation
...
namespace FTOptix.Core
{
  ...
  public class EUInformation : UAVariable
  {
    public int UnitId
    {
    ...
    {
      get => (int) this.GetOptionalVariableValue(nameof (NamespaceIndex)).Value;
      set => this.SetOptionalVariableValue(nameof (NamespaceIndex), new UAValue(value));
    }

    public IUAVariable NamespaceIndexVariable => this.GetOrCreateVariable("NamespaceIndex");
