...
// Type: FTOptix.Core.AuditConditionEnableEvent
...
{
  [CustomEventType(NamespaceUri = "http://opcfoundation.org/UA/", Number = 2803)]
  public class AuditConditionEnableEvent : AuditConditionEvent
  {
  }
}
