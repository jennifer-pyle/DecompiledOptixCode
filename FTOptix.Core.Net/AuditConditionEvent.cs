...
// Type: FTOptix.Core.AuditConditionEvent
...
{
  [CustomEventType(NamespaceUri = "http://opcfoundation.org/UA/", Number = 2790)]
  public class AuditConditionEvent : AuditUpdateMethodEvent
  {
  }
}
