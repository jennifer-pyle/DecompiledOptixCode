...
// Type: FTOptix.Core.GenericAttributes
...
{
  [MapDataType(NamespaceUri = "http://opcfoundation.org/UA/", Number = 17607)]
  public class GenericAttributes : TypedStruct
  {
    [StructFieldInfo(0, null, ValueRank.OneDimension, null)]
