...
// Type: UAManagedCore.ReadOnlyChildNodeCollection
...
{
  public class ReadOnlyChildNodeCollection : TypedReadOnlyChildNodeCollection<IUANode>
  {
    public ReadOnlyChildNodeCollection(IUANode node)
      : base(node)
    {
    }
