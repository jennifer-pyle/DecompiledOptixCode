...
namespace FTOptix.Store
{
  ...
  public class TableType : UAObjectType
  {
    ...
    public InstanceNodeCollection<Table> Instances
    {
      get => new InstanceNodeCollection<Table>((IUANode) this);
    }
  }
}
