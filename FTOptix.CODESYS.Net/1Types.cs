...
// Type: FTOptix.CODESYS.ObjectTypes
...
namespace FTOptix.CODESYS
{
  public static class ObjectTypes
  {
    ...
    public static readonly NodeId Driver = new NodeId(ObjectTypes.namespaceIndex, 3U);
    public static readonly NodeId Station = new NodeId(ObjectTypes.namespaceIndex, 4U);
  }
}
