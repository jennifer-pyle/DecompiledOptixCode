...
// Type: FTOptix.Report.DataGridSectionType
...
namespace FTOptix.Report
{
  ...
  public class DataGridSectionType : DataGridType
  {
    ...
    public InstanceNodeCollection<DataGridSection> Instances
    {
      get => new InstanceNodeCollection<DataGridSection>((IUANode) this);
    }
  }
}
