...
// Type: FTOptix.Report.ReportType
...
namespace FTOptix.Report
{
  ...
  public class ReportType : ColumnLayoutType
  {
    ...
    {
      get => (string) this.Refs.GetVariable(nameof (PageCount)).Value.Value;
      set => this.Refs.GetVariable(nameof (PageCount)).SetValue((object) value);
    }
    ...
    {
      get => (string) this.Refs.GetVariable(nameof (PageNumber)).Value.Value;
      set => this.Refs.GetVariable(nameof (PageNumber)).SetValue((object) value);
    }
    ...
    public DateTime PrintDateTime
    {
      ...
      set => this.Refs.GetVariable(nameof (PrintDateTime)).SetValue((object) value);
    }
    ...
    public InstanceNodeCollection<FTOptix.Report.Report> Instances
    {
      get => new InstanceNodeCollection<FTOptix.Report.Report>((IUANode) this);
    }
  }
}
