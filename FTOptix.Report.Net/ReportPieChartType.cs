...
// Type: FTOptix.Report.ReportPieChartType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:Report", Number = 492)]
  public class ReportPieChartType : PieChartType
  {
    ...
    public InstanceNodeCollection<ReportPieChart> Instances
    {
      get => new InstanceNodeCollection<ReportPieChart>((IUANode) this);
    }
  }
}
