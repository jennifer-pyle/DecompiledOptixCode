...
// Type: FTOptix.Report.ReportPanelType
...
namespace FTOptix.Report
{
  ...
  public class ReportPanelType : PanelType
  {
    ...
    public InstanceNodeCollection<ReportPanel> Instances
    {
      get => new InstanceNodeCollection<ReportPanel>((IUANode) this);
    }
  }
}
