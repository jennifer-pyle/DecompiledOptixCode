...
// Type: FTOptix.Report.ReportDataGridColumnType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:Report", Number = 32)]
  public class ReportDataGridColumnType : DataGridColumnType
  {
    public InstanceNodeCollection<ReportDataGridColumn> Instances
    {
      get => new InstanceNodeCollection<ReportDataGridColumn>((IUANode) this);
    }
  }
}
