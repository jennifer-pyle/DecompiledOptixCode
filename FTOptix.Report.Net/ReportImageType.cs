...
// Type: FTOptix.Report.ReportImageType
...
namespace FTOptix.Report
{
  ...
  public class ReportImageType : ImageType
  {
    ...
    public InstanceNodeCollection<ReportImage> Instances
    {
      get => new InstanceNodeCollection<ReportImage>((IUANode) this);
    }
  }
}
