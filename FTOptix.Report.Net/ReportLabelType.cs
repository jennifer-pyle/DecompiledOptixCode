...
// Type: FTOptix.Report.ReportLabelType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:Report", Number = 30)]
  public class ReportLabelType : LabelType
  {
    ...
    public InstanceNodeCollection<ReportLabel> Instances
    {
      get => new InstanceNodeCollection<ReportLabel>((IUANode) this);
    }
  }
}
