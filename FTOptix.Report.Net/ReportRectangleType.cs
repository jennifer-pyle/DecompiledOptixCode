...
// Type: FTOptix.Report.ReportRectangleType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:Report", Number = 31)]
  public class ReportRectangleType : RectangleType
  {
    ...
    public InstanceNodeCollection<ReportRectangle> Instances
    {
      get => new InstanceNodeCollection<ReportRectangle>((IUANode) this);
    }
  }
}
