...
// Type: FTOptix.Report.ReportStyleSheetType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:Report", Number = 192)]
  public class ReportStyleSheetType : StyleSheetType
  {
    public InstanceNodeCollection<ReportStyleSheet> Instances
    {
      get => new InstanceNodeCollection<ReportStyleSheet>((IUANode) this);
    }
  }
}
