...
// Type: FTOptix.SQLiteStore.SQLiteStoreType
...
namespace FTOptix.SQLiteStore
{
  ...
  public class SQLiteStoreType : StoreType
  {
    ...
    public InstanceNodeCollection<FTOptix.SQLiteStore.SQLiteStore> Instances
    {
      get => new InstanceNodeCollection<FTOptix.SQLiteStore.SQLiteStore>((IUANode) this);
    }
  }
}
