...
// Type: FTOptix.SQLiteStore.SQLiteStoreTableType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:SQLiteStore", Number = 3)]
  public class SQLiteStoreTableType : TableType
  {
    public InstanceNodeCollection<SQLiteStoreTable> Instances
    {
      get => new InstanceNodeCollection<SQLiteStoreTable>((IUANode) this);
    }
  }
}
