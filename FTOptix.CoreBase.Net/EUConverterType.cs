...
// Type: FTOptix.CoreBase.EUConverterType
...
namespace FTOptix.CoreBase
{
  ...
  public class EUConverterType : ConverterType
  {
    ...
    public InstanceNodeCollection<EUConverter> Instances
    {
      get => new InstanceNodeCollection<EUConverter>((IUANode) this);
    }
  }
}
