...
// Type: FTOptix.CoreBase.MethodInvocationType
...
namespace FTOptix.CoreBase
{
  ...
  public class MethodInvocationType : UAObjectType
  {
    ...
    public InstanceNodeCollection<MethodInvocation> Instances
    {
      get => new InstanceNodeCollection<MethodInvocation>((IUANode) this);
    }
  }
}
