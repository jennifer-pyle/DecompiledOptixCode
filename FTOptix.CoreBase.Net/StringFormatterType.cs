...
// Type: FTOptix.CoreBase.StringFormatterType
...
namespace FTOptix.CoreBase
{
  ...
  public class StringFormatterType : ConverterType
  {
    ...
    public InstanceNodeCollection<StringFormatter> Instances
    {
      get => new InstanceNodeCollection<StringFormatter>((IUANode) this);
    }
  }
}
