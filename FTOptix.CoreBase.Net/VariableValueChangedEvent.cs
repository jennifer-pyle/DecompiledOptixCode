...
// Type: FTOptix.CoreBase.VariableValueChangedEvent
...
{
  [CustomEventType(NamespaceUri = "urn:FTOptix:CoreBase", Number = 42)]
  public class VariableValueChangedEvent : VariableConditionEvent
  {
  }
}
