...
// Type: FTOptix.CoreBase.EventHandlerType
...
namespace FTOptix.CoreBase
{
  ...
  public class EventHandlerType : UAObjectType
  {
    ...
    public InstanceNodeCollection<EventHandler> Instances
    {
      get => new InstanceNodeCollection<EventHandler>((IUANode) this);
    }
  }
}
