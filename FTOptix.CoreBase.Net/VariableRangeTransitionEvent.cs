...
// Type: FTOptix.CoreBase.VariableRangeTransitionEvent
...
{
  [CustomEventType(NamespaceUri = "urn:FTOptix:CoreBase", Number = 120)]
  public class VariableRangeTransitionEvent : VariableConditionEvent
  {
  }
}
