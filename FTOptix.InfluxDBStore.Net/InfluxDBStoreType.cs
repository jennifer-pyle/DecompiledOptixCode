...
// Type: FTOptix.InfluxDBStore.InfluxDBStoreType
...
namespace FTOptix.InfluxDBStore
{
  ...
  public class InfluxDBStoreType : StoreType
  {
    ...
    public IUAVariable BucketVariable => this.Refs.GetVariable("Bucket");
    ...
    public IUAVariable ServerVariable => this.Refs.GetVariable("Server");
    ...
    public InstanceNodeCollection<FTOptix.InfluxDBStore.InfluxDBStore> Instances
    {
      get => new InstanceNodeCollection<FTOptix.InfluxDBStore.InfluxDBStore>((IUANode) this);
    }
  }
}
