...
// Type: FTOptix.HMIProject.ProjectFolder
...
namespace FTOptix.HMIProject
{
  ...
  public class ProjectFolder : Folder
  {
    ...
    {
      get => this.Localization.MeasurementSystemMap;
      set => this.Localization.MeasurementSystemMap = value;
    }
    ...
    {
      get => this.Localization.MeasurementSystemMapVariable;
    }
    ...
    public event EventHandler<ProjectLoadedEvent> OnProjectLoaded
    {
      add
      {
        this.GetOrCreateCustomEventHandler(new NodeId(NamespaceMapProvider.GetNamespaceIndex("urn:FTOptix:HMIProject"), 18U), typeof (EventHandler<ProjectLoadedEvent>), typeof (ProjectLoadedEvent)).Add((Delegate) value);
      }
      remove
      {
        this.GetOrCreateCustomEventHandler(new NodeId(NamespaceMapProvider.GetNamespaceIndex("urn:FTOptix:HMIProject"), 18U), typeof (EventHandler<ProjectLoadedEvent>), typeof (ProjectLoadedEvent)).Remove((Delegate) value);
      }
    }

    public string ProjectDirectory => this.Context.GetProjectDirectory(this.NodeId.NamespaceIndex);

    public string ApplicationDirectory
    {
      get => this.Context.GetApplicationDirectory(this.NodeId.NamespaceIndex);
    }
  }
}
