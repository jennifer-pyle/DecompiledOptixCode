...
// Type: FTOptix.HMIProject.SecurityCategoryFolder
...
{
  [MapType(NamespaceUri = "urn:FTOptix:HMIProject", Number = 55)]
  internal class SecurityCategoryFolder : CategoryFolder
  {
  }
}
