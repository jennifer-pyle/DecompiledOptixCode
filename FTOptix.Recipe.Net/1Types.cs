...
// Type: FTOptix.Recipe.ObjectTypes
...
namespace FTOptix.Recipe
{
  public static class ObjectTypes
  {
    ...
    public static readonly NodeId Recipe = new NodeId(ObjectTypes.namespaceIndex, 1U);
    public static readonly NodeId RecipeSchema = new NodeId(ObjectTypes.namespaceIndex, 2U);
    public static readonly NodeId RecipeApplicationEvent = new NodeId(ObjectTypes.namespaceIndex, 73U);
  }
}
