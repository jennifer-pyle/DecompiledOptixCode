...
// Type: FTOptix.ODBCStore.ODBCStoreTableType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:ODBCStore", Number = 3)]
  public class ODBCStoreTableType : TableType
  {
    public InstanceNodeCollection<ODBCStoreTable> Instances
    {
      get => new InstanceNodeCollection<ODBCStoreTable>((IUANode) this);
    }
  }
}
