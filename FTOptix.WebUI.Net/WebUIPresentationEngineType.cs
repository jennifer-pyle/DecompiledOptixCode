...
// Type: FTOptix.WebUI.WebUIPresentationEngineType
...
namespace FTOptix.WebUI
{
  ...
  public class WebUIPresentationEngineType : PresentationEngineType
  {
    ...
    public InstanceNodeCollection<WebUIPresentationEngine> Instances
    {
      get => new InstanceNodeCollection<WebUIPresentationEngine>((IUANode) this);
    }
  }
}
