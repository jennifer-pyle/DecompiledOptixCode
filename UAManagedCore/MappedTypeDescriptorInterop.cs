...
// Type: UAManagedCore.MappedTypeDescriptorInterop
...
{
  internal struct MappedTypeDescriptorInterop
  {
    ...
    public readonly bool InstanceTarget;

    public MappedTypeDescriptorInterop(MappedTypeDescriptor descriptor)
    {
      ...
      this.InstanceTarget = descriptor.InstanceTarget;
    }
  }
}
