...
// Type: FTOptix.Alarm.NonExclusiveDeviationAlarmControllerType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:Alarm", Number = 108)]
  public class NonExclusiveDeviationAlarmControllerType : NonExclusiveLimitAlarmControllerType
  {
    ...
    public InstanceNodeCollection<NonExclusiveDeviationAlarmController> Instances
    {
      get => new InstanceNodeCollection<NonExclusiveDeviationAlarmController>((IUANode) this);
    }
  }
}
