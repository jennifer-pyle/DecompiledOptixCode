...
// Type: FTOptix.Alarm.ExclusiveDeviationAlarmControllerType
...
namespace FTOptix.Alarm
{
  ...
  public class ExclusiveDeviationAlarmControllerType : ExclusiveLimitAlarmControllerType
  {
    ...
    public InstanceNodeCollection<ExclusiveDeviationAlarmController> Instances
    {
      get => new InstanceNodeCollection<ExclusiveDeviationAlarmController>((IUANode) this);
    }
  }
}
