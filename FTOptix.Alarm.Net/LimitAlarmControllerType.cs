...
// Type: FTOptix.Alarm.LimitAlarmControllerType
...
namespace FTOptix.Alarm
{
  ...
  public class LimitAlarmControllerType : AlarmControllerType
  {
    public double? HighHighLimit
    {
      get => new double?((double) this.Refs.GetVariable(nameof (HighHighLimit))?.GetValue());
      set
      {
        if (value.HasValue)
    ...
    {
      get => new double?((double) this.Refs.GetVariable(nameof (HighLimit))?.GetValue());
      set
      {
        if (value.HasValue)
    ...
    {
      get => new double?((double) this.Refs.GetVariable(nameof (LowLimit))?.GetValue());
      set
      {
        if (value.HasValue)
    ...
    {
      get => new double?((double) this.Refs.GetVariable(nameof (LowLowLimit))?.GetValue());
      set
      {
        if (value.HasValue)
    ...
    public InstanceNodeCollection<LimitAlarmController> Instances
    {
      get => new InstanceNodeCollection<LimitAlarmController>((IUANode) this);
    }
  }
}
