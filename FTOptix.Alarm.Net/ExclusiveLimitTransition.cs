...
// Type: FTOptix.Alarm.ExclusiveLimitTransition
...
{
  public enum ExclusiveLimitTransition
  {
    UndefinedTransition,
    HighHighToHighTransition,
    HighToHighHighTransition,
    LowLowToLowTransition,
    LowToLowLowTransition,
  }
}
