...
// Type: FTOptix.CommunicationDriver.CommunicationStationType
...
namespace FTOptix.CommunicationDriver
{
  ...
  public class CommunicationStationType : UAObjectType
  {
    ...
    public InstanceNodeCollection<CommunicationStation> Instances
    {
      get => new InstanceNodeCollection<CommunicationStation>((IUANode) this);
    }
  }
}
