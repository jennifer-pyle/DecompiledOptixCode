...
// Type: FTOptix.CommunicationDriver.TagStructureType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:CommunicationDriver", Number = 107)]
  public class TagStructureType : UAVariableType
  {
    public InstanceNodeCollection<TagStructure> Instances
    {
      get => new InstanceNodeCollection<TagStructure>((IUANode) this);
    }
  }
}
