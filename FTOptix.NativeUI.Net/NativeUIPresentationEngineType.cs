...
// Type: FTOptix.NativeUI.NativeUIPresentationEngineType
...
namespace FTOptix.NativeUI
{
  ...
  public class NativeUIPresentationEngineType : PresentationEngineType
  {
    ...
    public InstanceNodeCollection<NativeUIPresentationEngine> Instances
    {
      get => new InstanceNodeCollection<NativeUIPresentationEngine>((IUANode) this);
    }
