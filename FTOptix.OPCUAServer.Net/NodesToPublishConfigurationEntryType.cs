...
// Type: FTOptix.OPCUAServer.NodesToPublishConfigurationEntryType
...
namespace FTOptix.OPCUAServer
{
  ...
  public class NodesToPublishConfigurationEntryType : UAObjectType
  {
    ...
    public InstanceNodeCollection<NodesToPublishConfigurationEntry> Instances
    {
      get => new InstanceNodeCollection<NodesToPublishConfigurationEntry>((IUANode) this);
    }
  }
}
