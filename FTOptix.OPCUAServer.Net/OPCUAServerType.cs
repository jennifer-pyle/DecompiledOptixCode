...
// Type: FTOptix.OPCUAServer.OPCUAServerType
...
namespace FTOptix.OPCUAServer
{
  ...
  public class OPCUAServerType : UAObjectType
  {
    ...
    public InstanceNodeCollection<FTOptix.OPCUAServer.OPCUAServer> Instances
    {
      get => new InstanceNodeCollection<FTOptix.OPCUAServer.OPCUAServer>((IUANode) this);
    }
  }
}
