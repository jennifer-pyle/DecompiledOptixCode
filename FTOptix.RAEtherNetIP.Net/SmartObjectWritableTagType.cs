...
// Type: FTOptix.RAEtherNetIP.SmartObjectWritableTagType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:RAEtherNetIP", Number = 91)]
  public class SmartObjectWritableTagType : UAVariableType
  {
    public InstanceNodeCollection<SmartObjectWritableTag> Instances
    {
      get => new InstanceNodeCollection<SmartObjectWritableTag>((IUANode) this);
    }
  }
}
