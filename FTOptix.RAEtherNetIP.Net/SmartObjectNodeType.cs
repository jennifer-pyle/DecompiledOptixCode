...
// Type: FTOptix.RAEtherNetIP.SmartObjectNodeType
...
{
  [MapType(NamespaceUri = "urn:FTOptix:RAEtherNetIP", Number = 92)]
  public class SmartObjectNodeType : UAObjectType
  {
    public InstanceNodeCollection<SmartObjectNode> Instances
    {
      get => new InstanceNodeCollection<SmartObjectNode>((IUANode) this);
    }
  }
}
